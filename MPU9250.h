...
void MPU9250_calib_mag(void);
unsigned int MPU9250_whoami(void);
uint8_t AK8963_whoami(void);
uint8_t get_CNTL1(void);
void MPU9250_read_mag(void);
void MPU9250_read_all(void);
void MPU9250_calibrate(float *dest1, float *dest2);
 
extern float MPU9250_accel_data[3];
extern float MPU9250_gyro_data[3];
extern float MPU9250_mag_data[3];
extern float MPU9250_temperature;
extern uint8_t MPU9250_st_value;
